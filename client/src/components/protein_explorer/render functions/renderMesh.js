import { MeshBuilder, PointsCloudSystem, Vector3, Color3, StandardMaterial, Curve3 } from "@babylonjs/core"
...
export default function renderMesh (atomVectors, scene) {
    ...
    // const simplices = nearPoints.map((points) => {
    //     uniqueCombos(points, 3).map((combo) => computeCircumcenter(combo))
    // })

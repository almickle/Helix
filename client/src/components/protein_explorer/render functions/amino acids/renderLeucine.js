...
export default function renderLeucine (residue, scene) {
    ...
    const main = residue.filter((atom) => atom.atom_type === 'N' || atom.atom_type === 'CA' || atom.atom_type === 'CB' || atom.atom_type === 'CG' || atom.atom_type === 'CD2').map((atom) => new Vector3(atom.x, atom.y, atom.z))
    const methyl = residue.filter((atom) => atom.atom_type === 'CG' || atom.atom_type === 'CD1').map((atom) => new Vector3(atom.x, atom.y, atom.z))

...
export default function renderHistidine (residue, scene) {
    ...
    const main = residue.filter((atom) => atom.atom_type === 'CA' || atom.atom_type === 'CB' || atom.atom_type === 'CG' || atom.atom_type === 'ND1' || atom.atom_type === 'CE1' || atom.atom_type === 'NE2').map((atom) => new Vector3(atom.x, atom.y, atom.z))

...
export default function renderAsparagine (residue, scene) {
    ...
    const main = residue.filter((atom) => atom.atom_type === 'N' || atom.atom_type === 'CA' || atom.atom_type === 'CB' || atom.atom_type === 'CG' || atom.atom_type === 'ND2').map((atom) => new Vector3(atom.x, atom.y, atom.z))

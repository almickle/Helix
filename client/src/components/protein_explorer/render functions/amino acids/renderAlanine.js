...
export default function renderAlanine (residue, scene) {
    ...
    const main = residue.filter((atom) => atom.atom_type === 'N' || atom.atom_type === 'CA' || atom.atom_type === 'CB').map((atom) => new Vector3(atom.x, atom.y, atom.z))

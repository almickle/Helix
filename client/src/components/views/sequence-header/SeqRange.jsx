    ...
    return (
        <div style={{height: height, width: 'fit-content', backgroundColor: 'white', borderRadius: radius, marginLeft: 20, display: 'flex', flexDirection: 'row', position: 'relative', zIndex: 3 }}>
            <form autoComplete='off' onSubmit={handleSubmit}>       
                ...
                <input id='range-end' type='text' placeholder={selectedRegion[1]+1} style={{ height: height-2, width: 80, backgroundColor: 'white', borderRadius: radius, border: 'none' }} onFocus={(event) => handleFocus(event)}></input>
